#ifndef __CAR_QA__HPP__
#define __CAR_QA__HPP__
...
public:
	bool init(const acl::FileName& sBinDataFile, void* cppjiebaParser){
		...
		PE("[CarQA] amount of questions:"<<m_vAnswerIndex.size())
		PE("[CarQA] amount of words:"<<m_Tfidf.m_word_idx.size())
	...
	CarQAResult search(const std::string& sInput){
		CarQAResult result;
